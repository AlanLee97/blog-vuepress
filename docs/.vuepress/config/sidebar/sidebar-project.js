const configObj = {
  // 作业共享提醒
  homeworkReminder: {
    basePath: "/project/homework-reminder/",
    titles: [
      "作业提醒APP.md",
    ],
  },
  ...
  // 熊猫约拍
  pandaAppointment: {
    basePath: "/project/panda-appointment/",
    titles: [
      "部署配置.md",
      "说明文档.md",
      "项目中遇到的问题.md",
    ...
    sub: {
      createProject: {
        sub: {
          pandaAdmin: {
            basePath: "/project/panda-appointment/panda-admin/",
            titles: [
              "项目搭建 - 服务监控.md",
            ],
          },
          pandaConfig: {
            basePath: "/project/panda-appointment/panda-config/",
            titles: [
              "项目搭建 - 分布式配置中心.md",
              "流水线配置.md",
            ],
          ...
          pandaDependencies: {
            basePath: "/project/panda-appointment/panda-dependencies/",
            titles: [
              "项目搭建 - 统一的项目依赖.md",
            ],
          },
          pandaEureka: {
            basePath: "/project/panda-appointment/panda-eureka/",
            titles: [
              "项目搭建 - 服务注册与发现.md",
              "流水线配置.md",
            ],
          ...
          pandaServiceProviderUser: {
            basePath: "/project/panda-appointment/panda-service-provider-user/",
            titles: [
              "项目搭建 - 用户服务提供者.md",
            ],
          },
          pandaServiceRedis: {
            basePath: "/project/panda-appointment/panda-service-redis/",
            titles: [
              "Redis Sentinel 集群部署.md",
            ],
          },
          pandaSpringSecurityOauth2: {
            basePath: "/project/panda-appointment/panda-spring-security-oauth2/",
            titles: [
              "搭建OAuth2.md",
            ],
          },
      ...
      problems: {
        title: "遇到的问题",
        basePath: "/project/panda-appointment/problems/",
        titles: [
          "docker容器中时区不匹配问题.md",
  ...
  // UUID
  graduationProject: {
    basePath: "/project/graduation-project/",
    titles: [
      "调查问题.md",
      "选题.md",
      "招聘平台.md",
    ...
    sub: {
      problems: {
        basePath: "/project/graduation-project/problems/",
        titles: [
      ...
      moduleDesign: {
        basePath: "/project/graduation-project/module-design/",
        titles: [
          "秒杀模块设计.md",
        ],
      },
