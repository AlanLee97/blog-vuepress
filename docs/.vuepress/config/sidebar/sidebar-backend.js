const configObj = {
  java: {
    ...
    sub: {
      ...
      readSource: {
        title: "阅读源码",
        basePath: "/back-end/java/read-source/",
        titles: [
          "1.Object类.md",
          "2.String类.md",
          "3.StringBuffer类.md",
      ...
      javaSE: {
        ...
        sub: {
          thread: {
            title: "多线程",
            basePath: "/back-end/java/javase/thread/",
            titles: [
              "多线程01-基本知识.md",
              "多线程02-线程的操作.md",
              "多线程03-线程的同步.md",
          ...
          stream: {
            title: "流",
            basePath: "/back-end/java/javase/stream/",
            titles: [
              "Stream01 - 控制台输入.md",
              "Stream02 - 读写文件.md",
              "Stream03 - 目录操作.md",
      ...
      javaEE: {
        sub: {
          ssm: {
            title: "SSM",
            basePath: "/back-end/java/javaee/SSM/",
            titles: [
          ...
          springboot: {
            title: "Spring Boot",
            basePath: "/back-end/java/javaee/springboot",
            titles: [
              "",
            ],
          }
  ...
  microservice: {
    basePath: "/back-end/microservice/",
    titles: [
      "微服务优缺点.md",
    ]
  }
